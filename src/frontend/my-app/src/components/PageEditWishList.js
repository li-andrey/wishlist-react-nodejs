...
// PATCH редактирование в WishListItem Assignee
async function patchWishListItemAssignee(wishListItemId, wishListId) {
  // Default options are marked with *
  const data = {}
...
export default function EditWishList() {
  ...
  // отправление POST запроса для подтверждения Assignee
  const handleWishListItemAssignee = () => {
    patchWishListItemAssignee(wishListItemId, wishListId);
  };
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input type="checkbox" onClick={handleWishListItemAssignee} />
              </td>
              <td>
