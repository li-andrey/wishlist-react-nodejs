...
export default function EditWishList() {
    ...
    const handleNewWishListItem = async () => {
        const newWishListItem = await postNewWishListItem(
            wishListId,
            picture,
            title,
            comment,
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    type="checkbox" /*  onClick={handleUpdateWishListItem}  */
                                />
                            </td>
                            <td>
                                <button onClick={handleNewWishListItem}>
                                    Добавить
                                </button>
                            </td>
                            <td>
                                <button /* onClick={handleUpdateWishListItem} */
                                >
                                    Редактировать
                                </button>
                            </td>
            ...
            <div>
                {wishListItems.map(el => (
                  <div key={el._id} style={{ display: 'flex'}}>
                      <div style={{ flexBasis: 160, flexGrow: 0, flexShrink: 0}}><img width={150} src={el.picture}/></div>
